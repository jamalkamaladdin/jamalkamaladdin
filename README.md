...
<p align="center">
  <img alt="articles" src="https://img.shields.io/badge/articles-500%2B-6c5ce7?style=flat-square">
  ...
  <img alt="glossary" src="https://img.shields.io/badge/glossary-1000_terms-2ec27e?style=flat-square">
</p>
...
developer tools that work entirely in the browser. JWT decoder, cron parser,
regex tester, DNS and SSL lookups, CIDR maths, JSON and Base64 work. No signup,
no tracking, MIT.

<a href="https://github.com/jamalkamaladdin/camalali-tools"><img alt="tools" src="https://img.shields.io/badge/tools-166-3584e4?style=flat-square"></a>
<img alt="categories" src="https://img.shields.io/badge/categories-12-3584e4?style=flat-square">
<img alt="test cases" src="https://img.shields.io/badge/test_cases-2350%2B-12a5a5?style=flat-square">
...
[/alet](https://camalali.com/alet) ·
[/luget](https://camalali.com/luget) ·
[/sablonlar](https://camalali.com/sablonlar)
...
Problemin mahiyyətini anlayacaq qədər texniki, həll prosesini idarə edəcək qədər
təcrübəli. İşimin böyük hissəsi bizneslə texnologiyanın ortasında keçir: biznesin
...
çünki bu dildə bu dərinlikdə mühəndislik mətni demək olar ki yoxdur.
...
məlumat heç yerə getmir. 2 350-dən çox test halı, MIT.

Eyni 166 alət kitabxana kimi də paylanır: `npm i zero-dep-devtools`
...
500-dən çox sistem dizaynı yazısı, 1000 terminlik azərbaycanca texniki lüğət,
rol üzrə yol xəritələri və yuxarıdakı alətlər, canlı işləyən halda.
